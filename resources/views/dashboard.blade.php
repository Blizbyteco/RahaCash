...
<body class="g-sidenav-show bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand px-4 py-3 m-0" href=" https://demos.creative-tim.com/material-dashboard/dashboard " target="_blank">
        <h1 class="ms-1 text-lg text-dark">Raha xCash</h1>
      </a>
    </div>
    ...
    <div class="container-fluid py-2">
      <div class="row">
        <div class="ms-3">
          ...
          <p class="mb-4">
            Dasbor untuk manajemen kuangan dan karyawan Rahmat Bengkel
          </p>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-success font-weight-bolder">+55% </span>dari minggu kemarin</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-capitalize">Pemasukan hari ini</p>
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-success font-weight-bolder">+3% </span>dari bulan kemarin</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card h-100">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-capitalize">Stock Barang</p>
                  <h4 class="mb-0">2.120 Barang</h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
            ...
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h4 class="mb-0">120 Pengunjung</h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
      ...
      <div class="row align-items-start">
        ...
        <div class="col mt-4 mb-4">
          <div class="card ">
            <div class="card-body">
              <h6 class="mb-0 ">Statisik Pembeli</h6>
        ...
        <div class="col">
          <div class="card h-100">
            <div class="card-header pb-0">
              <h6>Histori keuangan</h6>
              <p class="text-sm">
                Termasuk pengeluaran dan pemasukan
              </p>
            </div>
              ...
              <div class="timeline timeline-one-side">
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Restock, Ban Federal (Rp. 30.000)</h6>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                made by
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Blizbyteco</a>
